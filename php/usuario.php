...
$user=$_SESSION['numb'];
$select="SELECT id,tdoc,ndocu,nombre,fnaci,correo,direccion,numcont FROM clientes WHERE ndocu='".$user."'";
...
<body>
    <div class="tds">
        <div class="inte">
            <div class="prin">
                ...
                <p class="fatex"><?php echo $nombre?></p>
            </div>
            <div class="bts-imfo">
                <div class="">
            ...
            <div class="container-modal show" id="metodopago">
                ...
                <div class="anun ult">
                    ...
                    <div class="franu">
                        ...
                        <button id="bot" class="bot">Guardar cambios </button>
                    </div>
                    <div class="frafi">
                        <div>
                            <p>Albero Guztabo Perez</p>
                        </div>
                        <div>
                            <p>Seleccione su banco</p>
                        </div>
                        <div>
    ...
    <div class="overlay" id="overlay">
        <div class="popup" id="popup">
                ...
                <div class="sec">
                    <button class="bot">Continuar</a> </button>
                    <button class="bot">Volver</a> </button>
                </div>
        </div>
     </div>
     <div class="overlay" id="overlay">
        <div class="popup" id="popup">
                ...
                <div class="sec">
                    <button class="bot"><a href="ususario.php">volver al menu de usuario</a> </button>
                    <button class="bot"><a href="iniciado.php">Volver a la pagina de principal</a> </button>
                </div>
        </div>
     </div>
</body>
