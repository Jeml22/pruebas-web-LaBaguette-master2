                            ...
                            <div class="cart-menu" id="cartMenu">
                                ...
                                <div class="buttons">
                                    ...
                                    <div class="cam">
                                        ...
                                        <button onclick="subtotal()" class="bott" id="subtotal">Pagar Subtotal: $0000</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="menuconteiner">
                    ...
                    <div class="menu">
                        ...
                        <nav>
                            ...
                            <ul class="submenu">
                                <li><a class="sub" href="Nosotros.php">MISION Y VISION</a></li>
                                <li><a  class="sub" href="Nosotros.php">QUIENES SOMOS</a></li>
                            </ul>
                        </nav>
