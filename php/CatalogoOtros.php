    ...
    <main>
      <div class="product-catalog" id="novedades">
        ...
        <div class="button-pagination">
          ...
          <button id="menu-button"><a href="#" onclick="mostrarCatalogo('novedad')">2</a></button>
        </div>
      </div>
      <div class="product-catalog" id="novedad" style="display: none;">
        <div class="hero">
          <div class="conteiner">
            <div class="Nov">
              <p>NOVEDADES</p>
      ...
      <div class="product-catalog" id="dulces" style="display: none;">
        ...
        <div class="button-pagination">
          <button id="menu-button"><a href="#" onclick="mostrarCatalogo('dulces')">1</a></button>
          <button id="menu-button"><a href="#" onclick="mostrarCatalogo('confite')">2</a></button>
        </div>
      </div>
      <div class="product-catalog" id="confite" style="display: none;">
        <div class="hero">
          <div class="conteiner">
            <div class="Nov">
              <p>DULCES</p>
      ...
      <div class="product-catalog" id="empaquetados" style="display: none;">
        ...
        <div class="button-pagination">
          <button id="menu-button"><a href="#" onclick="mostrarCatalogo('empaquetados')">1</a></button>
          <button id="menu-button"><a href="#" onclick="mostrarCatalogo('paquetes')">2</a></button>
        </div>
      </div>
      <div class="product-catalog" id="paquetes" style="display: none;">
        <div class="hero">
          <div class="conteiner">
            <div class="Nov">
              <p>EMPAQUETADOS</p>
      ...
      <div class="product-catalog" id="Bebidas" style="display: none;">
        ...
        <div class="button-pagination">
          <button id="menu-button"><a href="#" onclick="mostrarCatalogo('Bebidas')">1</a></button>
          <button id="menu-button"><a href="#" onclick="mostrarCatalogo('tomar')">2</a></button>
        </div>
      </div>
      <div class="product-catalog" id="tomar" style="display: none;">
        <div class="hero">
          <div class="conteiner">
            <div class="Nov">
              <p>BEBIDAS</p>
